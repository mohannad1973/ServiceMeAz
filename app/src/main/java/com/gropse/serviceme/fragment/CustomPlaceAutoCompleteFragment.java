...
public class CustomPlaceAutoCompleteFragment extends PlaceAutocompleteFragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        editSearch = var4.findViewById(R.id.editWorkLocation);
        editSearch.setSelected(true);
    ...
    private void zzzG() {
        ...
        try {
            Intent var2 = (new PlaceAutocomplete.IntentBuilder(2)).setBoundsBias(this.zzaRk).setFilter(this.zzaRl).zzih(this.editSearch.getText().toString()).zzdu(1).build(this.getActivity());
